...
public abstract class AbstractPersonInformationRepositoryIntegrationTest<T extends AbstractPersonInformation> extends AbstractRepositoryIDIntegrationTest<T>{
	...
	protected abstract AbstractPersonInformationRepository<T> getInfoRepository();
	...
	public void testFindByValue()
	{
		...
		manager.flush();
		AbstractPersonInformationRepository<T> repo = (AbstractPersonInformationRepository<T>)repository;
		T otherDummy = (T)repo.findByValue(dummy.getPerson().getId(), dummy.getValue());
