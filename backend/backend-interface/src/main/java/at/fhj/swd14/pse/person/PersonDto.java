...
public class PersonDto implements Serializable {
	...
	private List<String> hobbies=new LinkedList<String>();
	 
	private List<String> knowledges=new LinkedList<String>();
	 
	private List<String> additionalMails=new LinkedList<String>();
