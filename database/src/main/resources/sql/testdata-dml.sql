...
#test communities
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`, `isactive`) VALUES ('1', 'test1', true, 1, NULL, NULL, true);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`, `isactive`) VALUES ('2', 'test2', true, 2, NULL, NULL, true);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`, `isactive`) VALUES ('3', 'test3', true, 3, NULL, NULL, true);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`, `isactive`) VALUES ('4', 'test4', true, 4, NULL, NULL, true);
