...
INSERT INTO `communities` (`id`, `name`, `public`, `author_id`, `created`, `modified`) VALUES ('3', 'test3', true, 'student3', NULL, NULL);
INSERT INTO `communities` (`id`, `name`, `public`, `author_id`, `created`, `modified`) VALUES ('4', 'test4', true, 'student4', NULL, NULL);
