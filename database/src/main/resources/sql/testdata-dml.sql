...
#test communities
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`) VALUES ('1', 'test1', true, 1, NULL, NULL);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`) VALUES ('2', 'test2', true, 2, NULL, NULL);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`) VALUES ('3', 'test3', true, 3, NULL, NULL);
INSERT INTO `community` (`id`, `name`, `ispublic`, `author_id`, `created`, `modified`) VALUES ('4', 'test4', true, 4, NULL, NULL);
