...
public class CommonPersonBeanTest {
	...
	public static CommonPersonBeanTestData setupTest(UserService userService,PersonService personService, DepartmentService departmentService)
	{
